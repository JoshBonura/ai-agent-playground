...
from .generate_pipeline_support import Prep, _approx_block_tokens, _bool
...
async def prepare_generation_with_telemetry(data: ChatBody) -> Prep:
    ...
    temperature = float(
        eff["default_temperature"] if data.temperature is None else data.temperature
    )
